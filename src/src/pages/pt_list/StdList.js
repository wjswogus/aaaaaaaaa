      ...
      <Container>
        ...
        <FlexStyle>
           {shops.map((shop) => (
             ...
             <CardImgStyle src={shop.st_img}/>
            <div>
                <AddStyle>{shop.st_address}</AddStyle>
                <Link shop={shop} to={`/stshop/${shop.stNo}`}>
                  <TitleStyle>{shop.pt_name}</TitleStyle>
                </Link>

                
                <PriceStyle>{shop.st_price}</PriceStyle>
                <SummaryStyle>{shop.st_content}</SummaryStyle>
